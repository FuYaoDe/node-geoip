	...
	do {
		...
		if (floor <= ip && ceil >= ip) {
			...
			if (recordSize === RECORD_SIZE) {
				...
				geodata.city = locBuffer.toString('utf8', (locId * locRecordSize) + 42, (locId * locRecordSize) + 42).replace(/\u0000.*/, '');
				geodata.cityZh = locBuffer.toString('utf8', (locId * locRecordSize) + 42, (locId * locRecordSize) + locRecordSize).replace(/\u0000.*/, '');
			}
